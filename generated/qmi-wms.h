 ...
 * @value_raw_message_data_raw_data: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_raw_message_data_raw_data will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @self: a #QmiMessageWmsSetRoutesInput.
 * @value_route_list: (in)(element-type QmiMessageWmsSetRoutesInputRouteListElement): a #GArray of #QmiMessageWmsSetRoutesInputRouteListElement elements. A new reference to @value_route_list will be taken.
 * @error: Return location for error or %NULL.
 *
