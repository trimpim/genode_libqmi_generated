 ...
 * @value_file_file_path: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_file_file_path will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @value_session_application_identifier: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_session_application_identifier will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @value_info_files: (in)(element-type QmiMessageUimRefreshRegisterInputInfoFilesElement): a #GArray of #QmiMessageUimRefreshRegisterInputInfoFilesElement elements. A new reference to @value_info_files will be taken.
 * @error: Return location for error or %NULL.
 *
 * Set the 'Info' field in the message.
 *
 ...
 * @value_application_information_application_identifier: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_application_information_application_identifier will be taken.
 * @error: Return location for error or %NULL.
 *
