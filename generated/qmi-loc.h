 ...
 * Since: 1.22
 */
typedef struct _QmiIndicationLocPositionReportOutputGpsTime {
    guint16 gps_weeks;
 ...
 * Since: 1.22
 */
typedef struct _QmiIndicationLocPositionReportOutputDilutionOfPrecision {
 ...
 * @self: a #QmiMessageLocInjectPredictedOrbitsDataInput.
 * @value_part_data: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_part_data will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @self: a #QmiMessageLocSetServerInput.
 * @value_ipv6_ipv6_address: (in)(element-type guint16): a #GArray of #guint16 elements. A new reference to @value_ipv6_ipv6_address will be taken.
 ...
 * @self: a #QmiMessageLocDeleteAssistanceDataInput.
 * @value_delete_sv_info: (in)(element-type QmiMessageLocDeleteAssistanceDataInputDeleteSvInfoElement): a #GArray of #QmiMessageLocDeleteAssistanceDataInputDeleteSvInfoElement elements. A new reference to @value_delete_sv_info will be taken.
 * @error: Return location for error or %NULL.
 *
