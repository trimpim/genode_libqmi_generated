 ...
 * @self: a #QmiMessageWdsCreateProfileInput.
 * @value_ipv6_secondary_dns_address_preference: (in)(element-type guint16): a #GArray of #guint16 elements. A new reference to @value_ipv6_secondary_dns_address_preference will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @self: a #QmiMessageWdsCreateProfileInput.
 * @value_ipv6_primary_dns_address_preference: (in)(element-type guint16): a #GArray of #guint16 elements. A new reference to @value_ipv6_primary_dns_address_preference will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @self: a #QmiMessageWdsCreateProfileInput.
 * @value_ipv6_address_preference_address: (in)(element-type guint16): a #GArray of #guint16 elements. A new reference to @value_ipv6_address_preference_address will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @value_requested_settings: (out)(optional): a placeholder for the output #QmiWdsGetCurrentSettingsRequestedSettings, or %NULL if not required.
 * @error: Return location for error or %NULL.
 *
 ...
 * @self: a #QmiMessageWdsSetLteAttachPdnListInput.
 * @value_list: (in)(element-type guint16): a #GArray of #guint16 elements. A new reference to @value_list will be taken.
 * @error: Return location for error or %NULL.
 *
