 ...
 * @self: a #QmiMessagePdcDeleteConfigInput.
 * @value_id: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_id will be taken.
 * @error: Return location for error or %NULL.
 *
 ...
 * @value_config_chunk_id: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_config_chunk_id will be taken.
 * @value_config_chunk_total_size: a #guint32.
 * @value_config_chunk_chunk: (in)(element-type guint8): a #GArray of #guint8 elements. A new reference to @value_config_chunk_chunk will be taken.
 * @error: Return location for error or %NULL.
 *
